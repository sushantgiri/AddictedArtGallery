...
public class CustomProgressBar {
    ...
    public CustomProgressBar(Context context) {
        ...
        mWindowColor = context.getResources().getColor(R.color.custom_progress_bar_default_color);
        mAnimateSpeed = 1;
        mCornerRadius = 10;
        mIsAutoDismiss = true;
     ...
     */
    public static CustomProgressBar create(Context context) {
     ...
     * @return An unique HUD instance
     */
    public static CustomProgressBar create(Context context, Style style) {
        return new CustomProgressBar(context).setStyle(style);
    }
     ...
     * @return Current HUD
     */
    public CustomProgressBar setStyle(Style style) {
        View view = null;
        switch (style) {
     ...
     * @return Current HUD
     */
    public CustomProgressBar setDimAmount(float dimAmount) {
     ...
     * @return Current HUD
     */
    public CustomProgressBar setSize(int width, int height) {
     ...
     * @return Current HUD
     */
    public CustomProgressBar setWindowColor(int color) {
        mWindowColor = color;
        return this;
    }
     ...
     * @return Current HUD
     */
    public CustomProgressBar setCornerRadius(float radius) {
     ...
     * @return Current HUD
     */
    public CustomProgressBar setAnimationSpeed(int scale) {
        mAnimateSpeed = scale;
        return this;
    }
     ...
     * @return Current HUD
     */
    public CustomProgressBar setLabel(String label) {
     ...
     * @return Current HUD
     */
    public CustomProgressBar setDetailsLabel(String detailsLabel) {
     ...
     * @return Current HUD
     */
    public CustomProgressBar setMaxProgress(int maxProgress) {
     ...
     * @return Current HUD
     */
    public CustomProgressBar setCustomView(View view) {
        if (view != null) {
            mProgressDialog.setView(view);
        } else {
     ...
     * @return Current HUD
     */
    public CustomProgressBar setCancellable(boolean isCancellable) {
     ...
     * @return Current HUD
     */
    public CustomProgressBar setAutoDismiss(boolean isAutoDismiss) {
