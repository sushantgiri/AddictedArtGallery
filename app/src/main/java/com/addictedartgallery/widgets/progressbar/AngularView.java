...
class AngularView extends View implements Determinate {
    ...
    public AngularView(Context context) {
        super(context);
        init(context);
    }

    public AngularView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public AngularView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context){
        ...
        mGreyPaint.setColor(context.getResources().getColor(R.color.custom_progress_bar_grey_color));
